...
describe('getPublicDataToSignByGuarantee:', () => {
  it('Produces right bytes)', () => {
    ...
    expect(getPublicDataToSignByGuarantee(letterId, guaranteeU8, workerU8, amount)).toStrictEqual(expected);
  })
})
describe('getDataToSignByWorker:', () => {
  it('Produces right bytes)', () => {
    ...
    const workerU8 = new Uint8Array([178, 77, 57, 242, 36, 161, 83, 238, 138, 176, 187, 13, 7, 59, 100, 92, 45, 157, 163, 43, 133, 176, 199, 22, 118, 202, 133, 229, 161, 199, 255, 75,])
    const amount = 10
    const guaranteeSignatureU8 = new Uint8Array([96,20,15,21,11,137,10,192,129,3,154,34,203,118,28,19,176,54,165,181,227,156,70,197,73,86,226,111,137,243,69,95,41,74,25,254,228,34,212,189,141,134,194,44,229,172,27,43,67,73,73,58,61,63,37,176,120,195,153,198,46,42,231,129])
    ...
    expect(getDataToSignByWorker(letterId, guaranteeU8, workerU8, amount, guaranteeSignatureU8, employerU8)).toStrictEqual(expected);
  })
})
